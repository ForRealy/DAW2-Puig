...
function check(restaurant: typeof restaurantRest) {
...
function addMenu() {
    const menuPlato = (<HTMLInputElement>document.getElementById("plato")).value;
    const menuPrecio = (<HTMLInputElement>document.getElementById("precio")).value;
